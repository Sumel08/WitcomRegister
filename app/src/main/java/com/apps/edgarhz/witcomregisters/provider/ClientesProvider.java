package com.apps.edgarhz.witcomregisters.provider;

/**
 * Created by edgarhz on 17/01/16.
 */
...
public class ClientesProvider extends ContentProvider {
    ...
    private static final String uri =
            "content://com.apps.edgarhz.witcom.provider/clientes";
    ...
    public static final class Clientes implements BaseColumns
    {
        ...
        public static final String COL_EVENTO = "evento";
    }
    ...
    static {
        ...
        uriMatcher.addURI("com.apps.edgarhz.witcom.provider", "clientes", CLIENTES);
        uriMatcher.addURI("com.apps.edgarhz.witcom.provider", "clientes/#", CLIENTES_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        {
            case CLIENTES:
                return "vnd.android.cursor.dir/vnd.edgarhz.cliente";
            case CLIENTES_ID:
                return "vnd.android.cursor.item/vnd.edgarhz.cliente";
            default:
                return null;
        }
    }
